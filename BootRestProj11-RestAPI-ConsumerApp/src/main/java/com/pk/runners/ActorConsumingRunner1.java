...
//@Component
public class ActorConsumingRunner1 implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		//define servie ur;
		String baseUrl= "http://localhost:8082/BootRestProj11-RestAPI-ProviderApp/actor-api/wish/101/pavan";
